...
type GemTransaction = Tables<"gem_transactions">;

interface Props {
  searchParams: Promise<{ page?: string; user_id?: string; type?: string }>;
}

export default async function GemTransactionsPage({ searchParams }: Props) {
  ...
  const columns: Column<GemTransaction>[] = [
    {
      key: "id",
      header: "ID",
      className: "w-16",
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold">젬 거래내역</h1>
